...
%prep
%setup -q -n itstool-2.0.7
cd %{_builddir}/itstool-2.0.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632843829
...
cp %{_builddir}/itstool-2.0.7/COPYING %{buildroot}/usr/share/package-licenses/itstool/48703751ffc7d48dc3aa9609be19dd542cf9776b
cp %{_builddir}/itstool-2.0.7/COPYING.GPL3 %{buildroot}/usr/share/package-licenses/itstool/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
